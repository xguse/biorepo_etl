...
ETL logic for the biorepo redcap dump.
...
```shell
$ git clone https://github.com/xguse/biorepo_etl.git
```

Or via downloading a [zip](https://github.com/xguse/biorepo_etl/archive/master.zip) of the repository via the project's [github page](https://github.com/xguse/biorepo_etl).
